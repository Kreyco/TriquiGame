  ...
  >
    ...
    <template v-slot:top>
      <v-toolbar
          flat
      >
        <v-toolbar-title>{{ $t("userlist.title.user_crud") }}</v-toolbar-title>
        <v-divider
            class="mx-4"
            inset
            vertical
...
export default {
  ...
  data() {
    return {
      headers: [
        {
          text: this.$t("userlist.title.actions"),
          align: "left",
          sortable: false,
          value: "action"
        },
        ...
        {
          text: this.$t("userlist.title.last_name"),
          align: "left",
          sortable: false,
          value: "last_name"
        },
        {
          text: this.$t("userlist.title.email"),
          value: "email",
          align: "left",
          sortable: false
        }
